...
public class FavouriteMangaAdapter extends BaseCursorAdapter {
    public FavouriteMangaAdapter(Context context) {
        super(context, FavouriteManga.class);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentView == null) {
            currentView = LayoutInflater.from(mContext).inflate(R.layout.item_favourite_manga, parent, false);
        ...
        FavouriteManga currentFavouriteManga = (FavouriteManga) getItem(position);
        viewHolder.renderView(mContext, currentFavouriteManga);
    ...
    private static class ViewHolder {
        ...
        public void renderView(Context context, FavouriteManga favouriteManga) {
            setName(favouriteManga.getName());
            setSource(favouriteManga.getSource());
            setThumbnail(context, favouriteManga.getThumbnailUrl(), context.getResources().getColor(R.color.accentPinkA200));
        }
